...
function contactPage() {
  return pageShell(`
    <div class="contact-layout">
      <article class="panel reveal"><span class="eyebrow">تواصل معنا</span><h2>هل تريد مراجعة سيرتك أو قالباً خاصاً؟</h2><p class="lead">أرسل لنا احتياجك وسنقترح طريقة بناء نسخة مهنية متوافقة مع مجال عملك ومستوى خبرتك.</p><div class="roadmap"><div class="step-card"><div class="step-num">@</div><div><h3><a href="mailto:aytb9648@gmail.com">aytb9648@gmail.com</a></h3><p>راسلنا عبر البريد الإلكتروني</p></div></div><div class="step-card whatsapp-contact-card"><div class="step-num">وات</div><div><h3>تواصل واتساب مباشر</h3><p>اضغط الزر لبدء محادثة مباشرة مع فريق روَاج دون عرض رقم التواصل.</p><a class="primary-btn whatsapp-btn" href="https://wa.me/966544873310?text=${encodeURIComponent('مرحباً، أريد الاستفسار عن خدمات روَاج للسيرة الذاتية')}" target="_blank" rel="noopener" aria-label="فتح محادثة واتساب مباشرة مع روَاج">ابدأ محادثة واتساب</a></div></div></div></article>
